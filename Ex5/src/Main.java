public class Main {
    public static void main(String[] args) {
        ...
        // Assemble our pipeline via composition (Decorators)
        Exporter pdf = new SizeLimitedExporter(new PdfExporter(), 20, "PDF");
        Exporter csv = new TextSanitizingExporter(new CsvExporter());
